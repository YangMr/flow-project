  ...
  setup(__props) {
    ...
    const getTaskList = async () => {
      try {
        ...
        const result = await api_task.getTasks(requestParams.value);
      ...
      return common_vendor.e({
        a: common_vendor.f(taskList.value, (item, index, i0) => {
          return common_vendor.e({
            ...
            i: `/subpkg_task/record/index?id=${item.id}&startTime=${item.actualDepartureTime}`
          } : {}, {
            j: index
          });
        }),
...
const Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["__file", "/Users/yangling/Desktop/1907/实训2210B/flow-project/pages/task/components/delivery.vue"]]);
