...
const b = true, k = "mp-weixin", T = S([]), P = k, A = S('{\n    "address": [\n        "127.0.0.1",\n        "172.20.2.75"\n    ],\n    "debugPort": 9000,\n    "initialLaunchType": "local",\n    "servePort": 7000,\n    "skipFiles": [\n        "<node_internals>/**",\n        "/Applications/HBuilderX.app/Contents/HBuilderX/plugins/unicloud/**/*.js"\n    ]\n}\n'), E = S('[{"provider":"aliyun","spaceName":"flow","spaceId":"mp-03e0fce5-2bac-4801-b122-175617d4d012","clientSecret":"rjZQttRooAz5bQgB6ZYNWw==","endpoint":"https://api.next.bspapp.com"}]') || [];
let x = "";
try {
  x = "__UNI__F37D9E0";
} catch (e2) {
...
exports.createUniFetch_1 = dist.createUniFetch = void 0;
function createUniFetch(config) {
  ...
  const uniFetch = (options) => {
    ...
    if (!!(uniFetch === null || uniFetch === void 0 ? void 0 : uniFetch.loading) && !loadingQueue.length) {
      index.showLoading(Object.assign({}, uniFetch.loading));
    }
    loadingQueue.push("loading");
    return new Promise((resolve2, reject) => {
      index.request(Object.assign(Object.assign({}, options), { success: (result) => {
        resolve2(uniFetch.intercept.response(Object.assign(Object.assign({}, result), { config: options })));
  ...
  if ((_a2 = config === null || config === void 0 ? void 0 : config.intercept) === null || _a2 === void 0 ? void 0 : _a2.request) {
...
exports.createUniFetch_1 = dist.createUniFetch = createUniFetch;
